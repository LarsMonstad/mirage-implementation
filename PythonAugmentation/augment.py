...
if __name__ == "__main__":
    ...
    transforms = [
        ...
        #     "num_runs": 3,
        # },
        # {"instance": Gain(min_gain_in_db=-6, max_gain_in_db=6, p=1.0), "num_runs": 3},
        # {"instance": GainTransition(p=1.0), "num_runs": 3},
        #{"instance": HighPassFilter(p=1.0), "num_runs": 3},
        #{"instance": HighShelfFilter(p=1.0), "num_runs": 3},
        #{"instance": LowPassFilter(p=1.0), "num_runs": 3},
        #{"instance": LowShelfFilter(p=1.0), "num_runs": 3},
        # {
        ...
        # },
        #{"instance": PeakingFilter(p=1.0), "num_runs": 3},
        ...
        # },
        {"instance": TanhDistortion(p=1.0), "num_runs": 3},
        # {"instance": TimeMask(p=1.0), "num_runs": 3},
        # {"instance": TimeStretch(min_rate=0.8, max_rate=1.25, p=1.0), "num_runs": 3},
        # {
        #     "instance": Compose(
        #         [
        ...
        #     "name": "BigCompose",
        # },
        {"instance": AirAbsorption(p=1.0), "num_runs": 1},
    ]

    #for loop to do effects for each sound in file paths
    for sound_file_path in sound_file_paths:
        ...
        #samples = guitar, rate = none
        execution_times = {}

        #for loop to do a tran
                ...
                try:
                    with timer() as t:
                        augmented_samples = augmenter(
                            samples=samples, sample_rate=41000
                        )
...
#This is only a report to print the excetution time like a table
